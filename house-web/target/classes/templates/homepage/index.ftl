    ...
    <div id="slider" class="loading has-parallax">
        ...
        <div class="owl-carousel homepage-slider carousel-full-width">
            <div class="slide">
                ...
                <img alt="" src="/static/static/assets/img/slide-01.jpg">
            </div>
            <div class="slide">
                <div class="container">
                    <div class="overlay">
                ...
                <img alt="" src="/static/static/assets/img/slide-02.jpg">
            </div>
            <div class="slide">
                <div class="container">
                    <div class="overlay">
                ...
                <img alt="" src="/static/static/assets/img/slide-03.jpg">
            </div>
        </div>
    </div>
    <!-- end Slider -->
    ...
    <div id="page-content">
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonials-carousel">
                    <blockquote class="testimonial">
                        <figure>
                            <div class="image">
                                <img alt="" src="/static/static/assets/img/client-01.jpg">
                            </div>
                        </figure>
                        <aside class="cite">
        ...
        <section id="partners" class="block">
            <div class="container">
                ...
                <div class="logos">
                    <div class="logo"><a href=""><img src="/static/static/assets/img/logo-partner-01.png" alt=""></a></div>
                    <div class="logo"><a href=""><img src="/static/static/assets/img/logo-partner-02.png" alt=""></a></div>
                    <div class="logo"><a href=""><img src="/static/static/assets/img/logo-partner-03.png" alt=""></a></div>
                    <div class="logo"><a href=""><img src="/static/static/assets/img/logo-partner-04.png" alt=""></a></div>
                    <div class="logo"><a href=""><img src="/static/static/assets/img/logo-partner-05.png" alt=""></a></div>
                </div>
            </div><!-- /.container -->
        </section><!-- /#partners -->
    </div>
